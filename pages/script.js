...
let openModal = document.querySelector('.profile__button-edit'),
    modal = document.querySelector('.popup'),
    modalContainer = document.querySelector('.popup__container'),
    closeModal = modal.querySelector('.popup__close-button'),
    ...
    saveButton = formEditProfile.querySelector('.popup__botton'),
